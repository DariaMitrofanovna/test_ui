...
@Import({
		...
		APPNAME5PersistenceConfig.class
})
...
@BeanScan(value = {"groupid4"})
public class APPNAME5ApplicationConfig implements SchedulingConfigurer {
	...
	public ServletRegistrationBean api() {
		return createRegistration("api", APPNAME5APIConfig.class, "/api/v1/*");
	}
